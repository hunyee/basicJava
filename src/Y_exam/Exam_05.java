...
public class Exam_05 {
	public static void main(String[] args) {
		...
		a. int[] arr[]; 잘됨
		b. int[] arr = {1,2,3,}; 잘됨
		c. int[] arr = new int[5]; 잘됨
		d. int[] arr = new int[5]{1,2,3,4,5}; //방을 [5]로 생성하면 0으로 초기화되는데 거기에 값을 넣어서 에러, 5를 없애거나 뒤를 지우거나 // 안됨
		e. int arr[5]; 배열생성을 안함  //안됨
		f. int[] arr[] = new int[3][];  잘됨
		*/
		...
		배열 [3][] 3은 행을 의미 arr배열 3번째행은 {30, 30} arr[3].length는 2
		*/
...
//			}
//		}
//		average = (int)((float)total/(arr.length*arr[0].length)*100+0.5)/100f;
//		
//		System.out.println("total="+total);
//		System.out.println("average="+average);
...
//		 }
		...
		보유한 동전의 개수로 거스름돈을 지불할 수 없으면, ‘거스름돈이 부족합니다.’라고 출력하고 종료한다. 지불할 돈이 충분히 있으면, 거스름돈을 지불
...
//			}
//		}
//		System.out.printf("전체 %d문제중 %d문제 맞추셨습니다.", words.length , cnt);
