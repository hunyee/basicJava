...
public class Exam_04 {
	public static void main(String[] args) {
		...
		*/
		//1.
		int x = 5;
		System.out.println("1번" + (x>10&&x<20));
		//2
		char ch='A';
		System.out.println("2번" + !(ch=='\t'||ch==32));
		//3.
		System.out.println("3번" + (ch=='x'||ch=='X'));
		//4.
		System.out.println("4번" + ('0'<=ch&&ch<='9'));
		//5.
		System.out.println("5번" +('a'<=ch&&ch<='z'||'A'<=ch&&ch<='Z'));
		//6.
		int year = 700;
		...
		*/
		for(int x11=1; x11<6; x11++) {
			for(int y11=0; y11<4; y11++) {
				if (2*x11 + 4*y11 == 10) {
					System.out.println("x="+x11+ ", y=" + y11);
				}
...
//			char ch0 = str11.charAt(0);
//			char ch1 = str11.charAt(1);
//			char ch2 = str11.charAt(2);
//			char ch3 = str11.charAt(3);
//			char ch4 = str11.charAt(4);
//			
//			int c1 = (char)(ch4)-(char)(ch0) + 1;
//			int c2 = (char)(ch3)-(char)(ch0) + 1;
//			int c3 = (char)(ch2)-(char)(ch0) + 1;
//			int c4 = (char)(ch1)-(char)(ch0) + 1;
//			int c5 = (char)(ch0)-(char)(ch0) + 1;
//			
//			sum9 = c1+c2+c3+c4+c5;
			sum9 += str11.charAt(i) - '0';
		}
		...
		/*
		[4-11] 피보나치(Fibonnaci) 수열(數列)은 앞을 두 수를 더해서 다음 수를 만들어 나가는 수열이다. 예를 들어 앞의 두 수가 1과 1이라면 그 다음 수는 2가 되고 
		그 다음 수는1과 2를 더해서 3이 되어서 1,1,2,3,5,8,13,21,... 과 같은 식으로 진행된다. 1과 1부터시작하는 피보나치수열의 10번째 수는 무엇인지 계산하는 프로그램을 완성하시오.
